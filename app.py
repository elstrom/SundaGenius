...
def git_commit(file_path):
    try:
        ...
        # Menggunakan GitHub CLI untuk push
        subprocess.run(["gh", "repo", "set-default", "elstrom/SundaGenius"], check=True)
        subprocess.run(["gh", "repo", "clone", "elstrom/SundaGenius"], check=True)
